...
const StandardSingleAvail = ({ open, setOpen }) => {
    ...
    async function fetchData() {
      try {
        ...
        const res = await axios.get(
          `https://hic-backend.onrender.com/getbookedRoomsByroomType/661901d82831864696c9ff70`,
          {
  ...
  const handleDownloadCSV = () => {
    ...
    a.href = url;
    a.download = 'Standard Single.csv';
...
export default StandardSingleAvail;
