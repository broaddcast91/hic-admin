...
const DelDoubleAvail = ({ open, setOpen }) => {
    ...
    async function fetchData() {
      try {
        ...
        const res = await axios.get(
          `https://hic-backend.onrender.com/getbookedRoomsByroomType/661902892831864696c9ff7a`,
          {
