...
const ExeSingleAvail = ({ open, setOpen }) => {
    ...
    async function fetchData() {
      try {
        ...
        const res = await axios.get(
          `https://hic-backend.onrender.com/getbookedRoomsByroomType/661902282831864696c9ff74`,
          {
  ...
  const handleDownloadCSV = () => {
    ...
    a.href = url;
    a.download = 'Executive Single.csv';
