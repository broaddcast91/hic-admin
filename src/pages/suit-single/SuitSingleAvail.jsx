...
const SuitSingleAvail = ({ open, setOpen }) => {
    ...
    async function fetchData() {
      try {
        ...
        const res = await axios.get(
          `https://hic-backend.onrender.com/getbookedRoomsByroomType/6619029d2831864696c9ff7c`,
          {
...
export default SuitSingleAvail;
