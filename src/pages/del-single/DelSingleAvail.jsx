...
const DelSingleAvail = ({ open, setOpen }) => {
    ...
    async function fetchData() {
      try {
        ...
        const res = await axios.get(
          `https://hic-backend.onrender.com/getbookedRoomsByroomType/661902732831864696c9ff78`,
          {
