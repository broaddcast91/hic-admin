...
const BanquetTable = ({ open, setOpen }) => {
    ...
    async function fetchData() {
      try {
        ...
        const res = await axios.get(
          `https://hic-backend.onrender.com/getbanquetHall/${storedUserId}`,
          {
  ...
  const handleStatusChange = (row, newStatus) => {
    ...
    axios
      .put(
        `https://hic-backend.onrender.com/updateStatusOfBanquetHall/${row.id}/${storedUserId}`,
        { status: newStatus },
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const columns = [
    ...
    { field: 'banquethalltype', headerName: 'HallType', width: 230 },
